...
export const COMMISSIONS: Commission[] = [
  {
    ...
    npcId: "npc-xiaomei",
    letter:
      "小梅急匆匆跑来：明天的日报头版还空着一块。「听说灯塔坡昨晚又亮了一整夜——你帮我去问一句？问不出来我就自己编一个。」",
    choices: [
    ...
    outcomes: {
      "story:go_check": (bold) => ({
        scene: bold
          ? "它天没黑就蹲到了灯塔坡下。盐汽水果然在，抱着一盏修了一半的灯出来倒水，看见它愣了愣：「跟小梅说，是我在修灯。别写得神神鬼鬼的。」第二天日报头版：《灯塔的灯，有猫在修》"
          : "它在坡下犹豫了很久，最后只敢远远看着。灯亮着，窗后有个影子来回走动——修东西的姿势。它把看到的原样告诉了小梅，一个字也没多说。小梅撇撇嘴，还是照着写了",
        affinity: 8,
        reason: "跑腿跑出了头版",
      ...
      "story:talk_her_down": () => ({
        scene:
          "它蹲在小梅的桌角，看她把「灯塔闹鬼」的标题写了又划、划了又写，最后叹了口气改成《岛上的夜晚》，配一张糯米画的坡地速写。「没劲透了，」小梅说，「但你说得对，盐汽水会难过的。」",
        affinity: 10,
        reason: "拦下了一条不该写的新闻",
    ...
    fallback: (bold) => ({
      scene: bold
        ? "没等谁发话，它自己溜到了灯塔坡下张望了半天，什么也没看清，回来跟小梅说「就是有灯」。小梅照着写了《灯塔的灯还亮着》，反响平平"
